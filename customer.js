const BASE = "https://yourdomain.com/api";   // ← FastAPI backend manzilingiz
...
async function loadMenu() {
  ...
  data.forEach(p => {
    ...
    div.innerHTML = `<b>${p.name}</b> ${p.price} so‘m
...
document.getElementById("getLoc").onclick = () => {
  if (!navigator.geolocation) return alert("Brauzer geolocation qo‘llab-quvvatlamaydi");
